...
class Fly:
    ...
    def fly(self):
        ...
        self._turtle.penup()
        self._turtle.goto(self.x - 30, self.y - 30)
        self._turtle.pendown()
...
class MallardDuck(Duck,Display,Swim,Fly,Quack):
    __myShape = None
    color = None
...
class RedDuck(Duck,Display,Swim,Fly,Quack):
    __myShape = None
    color = None
...
class DecoyDuck(Duck,Display,Swim):
    __myShape = None
    color = None
